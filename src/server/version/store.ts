 ...
 * build bump (depot version rises but matchmaking keeps the previous build's
 * category) doesn't lose us our working category across restarts. Mount the
 * state dir as a volume to keep it across container recreation.
 */
