...
/**
 * Stylised Bloodpoint motif (a glossy blood drop) in the spirit of the in-game
 * currency. An original recreation, not Behaviour's official asset, so the app
 * stays self-contained. Drop a real `bloodpoint.svg/png` into the UI to swap it.
 */
