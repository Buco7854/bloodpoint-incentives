...
/**
 * Visualises the live killer:survivor queue ratio. A higher ratio means killers
 * outnumber survivors, so the killer segment grows (and survivors earn the bonus).
 */
  ...
  return (
    <div>
      <div className="mb-1 flex items-center justify-between text-[11px] uppercase tracking-wide text-bone-500">
        <span>Survivor</span>
        <span className="tabular text-bone-400">ratio {ratio.toFixed(2)}</span>
        <span>Killer</span>
      </div>
